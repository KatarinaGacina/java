...
public class ArrayIndexedCollection implements List {
	...
	*/
	...
	private static class ElementsGetterArray implements ElementsGetter {
		 ...
		 * @param a ArrayIndexedCollection for which the ElementsGetter is created
		 */
		private ElementsGetterArray(ArrayIndexedCollection a) { 
			this.a = a;
		...
		public Object getNextElement() {
			...
			return a.elements[this.trenutniIndex++];
		}
